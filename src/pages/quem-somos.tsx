        ...
        <DefaultTemplate>
            <Container className={`relative !pt-24  min-h-screen`}>
                <Wrapper className={`my-0 xl:my-auto items-start xl:items-center justify-start xl:justify-center`}>
                    <img className={`absolute left-0 w-full h-full top-0 hidden xl:block object-cover`}  src={`/backgrounds/quem-somos-1.png`} />
                    <img className={`absolute left-0 w-full h-full top-0 xl:hidden object-cover`}  src={`/backgrounds/quem-somos-1-mobile.png`} />
            ...
            <Container className={`relative !pt-24  min-h-screen`}>
                <Wrapper className={`my-0 xl:my-auto items-start xl:items-center justify-start xl:justify-center`}>
                    <img className={`absolute left-0 w-full h-full top-0 hidden xl:block object-cover`}  src={`/backgrounds/quem-somos-2.png`} />
                    <img className={`absolute left-0 w-full h-full top-0 xl:hidden object-cover`}  src={`/backgrounds/quem-somos-2-mobile.png`} />
                    <Slide left>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row`}>

                        <Stack spacing={40} className={`xl:w-5/12`}>
                            <img src={`/icons/missao.svg`} className={`w-[60px]`} />
                            <Text className={`text-[36px] xl:text-[38px] font-semibold`} style={{
                                lineHeight: `111%`,
                                letterSpacing: `-4% `
                            }}>Missão.</Text>
                            <Text className={`!text-white inter h2-regular xl:text-[16px]`}>
            ...
            <Container className={`relative !pt-24  min-h-screen`}>
                <Wrapper className={`my-0 xl:my-auto items-start xl:items-center justify-start xl:justify-center`}>
                    <img className={`absolute left-0 w-full h-full top-0 hidden xl:block object-cover`}  src={`/backgrounds/quem-somos-3.png`} />
                    <img className={`absolute left-0 w-full h-full top-0 xl:hidden object-cover`}  src={`/backgrounds/quem-somos-3-mobile.png`} />
                    <Slide right>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row justify-end`}>
            ...
            <Container className={`relative !pt-24  min-h-screen`}>
                <Wrapper className={`my-0 xl:my-auto items-start xl:items-center justify-start xl:justify-center`}>
                    <img className={`absolute left-0 w-full h-full top-0 hidden xl:block object-cover`}  src={`/backgrounds/quem-somos-4.png`} />
                    <img className={`absolute left-0 w-full h-full top-0 xl:hidden object-cover`}  src={`/backgrounds/quem-somos-4-mobile.png`} />
                    <Slide left>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row`}>
                        <Stack spacing={40} className={`xl:w-5/12`}>
                            ...
                            <Stack spacing={32}>
                                ...
                                <ul className={`!list !list-disc [&>li]:marker:!text-white pl-5`}>
                                    <li><Text className={`!text-white inter h2-regular xl:text-[16px]`}>Tecnologia e Inovação</Text></li>
                                    <li><Text className={`!text-white inter h2-regular xl:text-[16px]`}>Qualidade e Excelência</Text></li>
                                    <li><Text className={`!text-white inter h2-regular xl:text-[16px]`}>Profundidade de conhecimento</Text></li>
                                    <li><Text className={`!text-white inter h2-regular xl:text-[16px]`}>Dedicação e performance</Text></li>
                                </ul>
                            </Stack>
                        </Stack>
                    </Flex>
            ...
            <Container className={`relative !pt-24  min-h-screen`}>
                <Wrapper className={`items-start xl:items-center justify-start xl:justify-center`}>
                    <img className={`absolute left-0 w-full h-full top-0 hidden xl:block object-cover`}  src={`/backgrounds/quem-somos-5.png`} />
                    <img className={`absolute left-0 w-full h-full top-0 xl:hidden object-cover`}  src={`/backgrounds/quem-somos-5-mobile.png`} />
                    <Slide bottom>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row`}>
                        <Stack spacing={40} className={` items-center`}>
                            <Text className={`!text-gray_3 inter text-[16px] xl:text-[24px] text-center`}>
                            ...
                            <Button className={`!px-6  !text-[12px] xl:!h1-semibold w-max`} >Faça parte desse universo <ArrowTopRight className={`ml-4 xl:ml-12 scale-75 xl:scale-100`} /></Button>
                        </Stack>
                    </Flex>
                    </Slide>
                </Wrapper>
