        ...
        <DefaultTemplate>
            <Container className={`relative !pt-24  min-h-screen z-50`}>
                <Wrapper className={`my-0 md:my-auto items-start md:items-center justify-start md:justify-center`}>
                    <img className={`absolute left-0 w-full h-full top-0 hidden md:block object-cover`}
                         src={`/backgrounds/nossos-servicos-1.png`}/>
                    <img className={`absolute left-0 w-full h-auto bottom-0 md:hidden `}
            ...
            <Container className={`relative md:!pb-10  bg-[#FAFAFA]`}>
                <Wrapper
                    className={`my-0 md:my-auto items-start md:items-center justify-start md:justify-center !flex-col gap-10 [&>div]:overflow-hidden`}>
                    <Flex
                        className={`w-full z-50 gap-16 flex-col md:flex-row bg-white pb-0 px-6 pt-6 md:px-16 md:py-32 rounded-[24px] shadow-common relative`}>
                        <Stack spacing={16} className={`md:w-[46%]`}>
                        ...
                        <Slide right>
                            <img
                                ...
                                className={`md:w-6/12 md:absolute right-0 bottom-0 max-h-full object-cover -ml-6 md:ml-0`}
                                style={isMobile ? {minWidth: `calc(100% + 48px)`} : {}}/>
                        </Slide>
                    </Flex>
                </Wrapper>
            </Container>
            <Container className={`relative md:!pt-0 md:!pb-10  bg-[#FAFAFA]`}>
                <Wrapper
                    className={`my-0 md:my-auto items-start md:items-center justify-start md:justify-center !flex-col gap-10 [&>div]:overflow-hidden`}>
                    <Flex
                        className={`w-full z-50 gap-16 flex-col md:flex-row bg-1 pt-0 px-6 pb-6 md:px-16 md:py-32  rounded-[24px] shadow-common relative justify-end`}>
                        <Slide left>
                            <img
                                src={isMobile ? `/images/nossos-servicos-2-mobile.png` : `/images/nossos-servicos-2.png`}
                                className={`md:w-6/12 md:absolute left-0 top-0 md:max-h-full md:object-cover -ml-6 md:ml-0`}
                                style={isMobile ? {minWidth: `calc(100% + 48px)`} : {}}/>
                        </Slide>
                        <Stack spacing={16} className={`md:w-[46%]`}>
                            <Box className={`bg-blue_primary w-max p-2 rounded-[16px]`}>
            ...
            <Container className={`relative md:!pt-0 bg-[#FAFAFA]`}>
                <Wrapper
                    className={`my-0 md:my-auto items-start md:items-center justify-start md:justify-center !flex-col gap-10 [&>div]:overflow-hidden`}>
                    <Flex
                        className={`w-full z-50 gap-16 flex-col-reverse md:flex-row bg-1 pb-0 px-6 pt-6 md:px-16 md:py-32  rounded-[24px] shadow-common relative justify-end`}>
                        <Slide left>
                            <img
                                src={isMobile ? `/images/nossos-servicos-6-mobile.png` : `/images/nossos-servicos-6.png`}
                                className={`md:w-6/12 md:absolute left-0 bottom-0 md:max-h-full md:object-cover -ml-6 md:ml-0`}
                                style={isMobile ? {minWidth: `calc(100% + 48px)`} : {}}/>
                        </Slide>
                        <Stack spacing={16} className={`md:w-[46%]`}>
                            <Box className={`bg-blue_primary w-max p-2 rounded-[16px]`}>
            ...
            <Container className={`relative `}>
                <Wrapper className={`items-center justify-center`}>
                    <img className={`absolute left-0 w-full bottom-0 hidden md:block`}
                         src={`/backgrounds/nossos-servicos-2.png`}/>
                    <img className={`absolute left-0 w-full bottom-0 md:hidden`}
                         src={`/backgrounds/nossos-servicos-2-mobile.png`}/>
                    <Flex className={`flex-1 w-full z-50 flex-col `}>
                        <Stack spacing={16}
                               className={`flex-1 bg-white md:items-center py-8 md:py-16 px-6 md:px-32 rounded-t-[12px] md:rounded-t-[24px]`}>
                            <Flex className={`flex-col md:flex-row md:items-center gap-6`}>
                                <img src={"/icons/b3-blue.svg"} className={`w-[60px] md:w-[60px]`}/>
                                <Text className={`text-[24px] md:text-[34px] md:text-center font-semibold !text-gray_1`}
                                      style={{
                                          lineHeight: `111%`,
                                          letterSpacing: `-4% `
                        ...
                        <Flex
                            className={`w-full h-[240px] md:h-[320px] bg-cover bg-left md:bg-center rounded-b-[8px] md:rounded-b-[24px]`}
