    ...
    return (
        <DefaultTemplate>
            <Container className={`relative !pt-24`}>
                <Wrapper className={`items-center justify-center`}>
                    ...
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col md:flex-row`}>
                        <Flex className={`flex-1`}>
                            <Slide left>
                                <Stack spacing={40} className={`flex-1`}>
                                    ...
                                    <Text className={`text-[30px] tracking-[-0.1rem] md:tracking-[-0.2rem] md:text-[44px] font-semibold`} style={{
                                        lineHeight: `111%`
                                    }}>Que tal ter sua
                                        DARF calculada automaticamente, sem pagar por isso?</Text>
                                    <Text className={`!text-gray_3 leading-[165%] inter h2-regular md:text-[16px]`}>
                        ...
                        <Stack className={`flex-1 min-w-6/12 my-auto`}>
                ...
                <Wrapper className={`items-center justify-center`}>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col md:flex-row`}>
                        <Stack spacing={40} className={`flex-1 items-center`}>
                            <Slide left>
                                <SimpleGrid columns={isMobile ? 1 : 3} className={`flex-1 w-full gap-3`}>
                            ...
                            <Button className={`!px-6 !py-2 h-max !text-[16px] !mt-6`} >Conheça nossos serviços <ArrowTopRight className={`ml-4 md:ml-12 scale-75 md:scale-100`} /></Button>
            ...
            <Container className={`relative md:!py-0`}>
                <Wrapper className={`items-center justify-center`}>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col md:flex-row justify-between`}>
                        <Stack spacing={isMobile ? 16 : 40} className={`flex-1 justify-center items-center`}>
                            <Flex className={`w-12 h-12 bg-blue_primary rounded-[12px] justify-center items-center`}>
                                <PeoplesIcon />
                            </Flex>
                            <Text className={`text-[24px] tracking-[-0.12rem] md:text-[34px] !mt-4 text-center md:text-left font-semibold`} style={{
                                lineHeight: `111%`,
                        ...
                        <Stack className={`flex-1 min-w-5/12 max-w-[470px]`}>
            ...
            <Container baseClassName={`z-50`} className={`relative !pb-0 z-50 `}>
                <Wrapper className={`items-center justify-center`}>
                    ...
                    <Flex className={`flex-1 w-full z-50 flex-col translate-y-12`}>
                        <Stack spacing={16} className={`flex-1 bg-white md:bg-1 items-center py-8 md:py-16 px-6 md:px-32 rounded-t-[12px] md:rounded-t-[24px]`}>
                            <Flex className={`flex-col md:flex-row items-center gap-6`}>
                                <img src={"/icons/b3-blue.svg"} className={`w-[60px] md:w-[60px]`}/>
                                <Text className={`text-[24px] tracking-[-0.12rem] md:text-[34px] text-center font-semibold !text-gray_1 md:!text-white`} style={{
                                    lineHeight: `111%`
                                }}>Integração com a B3</Text>
                            </Flex>
                            <Text className={`!text-gray_2 md:!text-gray_3 text-center inter text-[14px] md:text-[16px]`}>
                ...
                <Wrapper className={`items-center justify-center`}>
                    <Stack spacing={32} className={`flex-1 items-center py-16`}>
                        ...
                        <Link href={`https://dev.app.boleta.ai/fila-de-espera`} >
                            <Button className={`!px-6 !py-2 !text-[16px]`} >Solicite seu convite <ArrowTopRight className={`ml-4 md:ml-12 scale-75 md:scale-100`} /></Button>
                        </Link>
                ...
                <Wrapper className={`items-center justify-center bg-cover bg-center`}>
                    <Flex className={`flex-1 w-full z-50 flex-col -translate-y-12`}>
                        <Stack spacing={16} className={`flex-1 bg-1 items-center py-8 md:py-16 px-6 md:px-32 rounded-t-[12px] md:rounded-t-[24px]`}>
                            <Flex className={`flex-col md:flex-row items-center gap-6`}>
                                <img src={"/icons/b3-blue.svg"} className={`w-[60px] md:w-[60px]`}/>
                                <Text className={`text-[24px] tracking-[-0.12rem] md:text-[34px] text-center font-semibold`} style={{
                                    lineHeight: `111%`
                                }}>Prêmio Centelha</Text>
                            </Flex>
                            <Text className={`!text-gray_3 text-center inter text-[14px] md:text-[16px]`}>
                    ...
                    <Stack spacing={24} className={`w-full`}>
                        <Stack spacing={16} className={`flex-1 bg-1 rounded-t-[24px] mb-12`}>
                            <Flex className={`items-center gap-6`}>
                                <Text className={`md:text-[34px] tracking-[-0.12rem]  text-[24px] font-semibold`} style={{
                                    lineHeight: `111%`,
                                    letterSpacing: `-4% `
                                }}>Perguntas frequentes sobre o Boleta.ai</Text>
                            </Flex>
                            <Text className={`!text-gray_3 inter h2-regular md:text-[20px]`}>
                        ...
                        <Accordion defaultExpanded={true} header={<>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>A nossa plataforma é GRATUITA na versão 1.0.</Text>
                        </Accordion>
                        ...
                        <Accordion defaultExpanded={false} header={<>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>Você pode receber o convite através de um amigo que tenha cadastro na nossa plataforma ou aguardar que sua solicitação na lista de espera seja respondida.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold md:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>No boleta.ai fazemos tudo que a concorrência faz e você não gasta GRANA pra declarar seu CAPITAL.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold md:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>Você acessa a nossa plataforma de qualquer navegador, tanto pelo celular como no computador.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold md:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>TODAS as corretoras funcionam no boleta.ai, não importa se você tem conta em mais de uma.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold md:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>Ações, FIIs (fundos de investimento imobiliário), BDRs (Brazilian Depositary Receipts), ETFs (Exchange Traded Funds), Futuros e opções.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold md:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter md:text-[16px] !text-gray_3`}>Não. Os seus dados são extraídos diretamente da B3.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                    </Stack>
                </Wrapper>
