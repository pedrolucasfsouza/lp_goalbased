...
export default function Home() {
    ...
    const OpportunityItem = ({title, icon} : {title: string, icon?: any}) => {
        return (
            <Flex className={`flex-1 bg-gray_1/35 border-gray_1 border rounded-[24px] p-4 items-center gap-6`}>
    ...
    return (
        <DefaultTemplate>
            <Container className={`relative !pt-24`}>
                <Wrapper className={`items-center justify-center`}>
                    ...
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row`}>
                        <Flex className={`flex-1`}>
                            <Slide left>
                                <Stack spacing={40} className={`flex-1`}>
                                    ...
                                    <Text className={`text-[30px] tracking-[-0.1rem] xl:tracking-[-0.2rem] xl:text-[44px] font-semibold`} style={{
                                        lineHeight: `111%`
                                    }}>Que tal ter sua
                                        DARF calculada automaticamente, sem pagar por isso?</Text>
                                    <Text className={`!text-gray_3 leading-[165%] inter h2-regular xl:text-[16px]`}>
                        ...
                        <Stack className={`flex-1 ${isMedium && `w-8/12 mx-auto`} min-w-6/12 my-auto`}>
                ...
                <Wrapper className={`items-center justify-center`}>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row`}>
                        <Stack spacing={40} className={`flex-1 items-center`}>
                            ...
                            <Text className={`text-[24px] tracking-[-0.08rem] text-center font-semibold`} style={{
                                lineHeight: `111%`
                            }}>Bem-vindo! Há um universo de possibilidades.</Text>
                            <Button className={`!px-6 !py-2 h-max !text-[16px] !mt-6`} >Conheça nossos serviços <ArrowTopRight className={`ml-4 xl:ml-12 scale-75 xl:scale-100`} /></Button>
            ...
            <Container className={`relative xl:!py-0`}>
                <Wrapper className={`items-center justify-center`}>
                    <Flex className={`flex-1 w-full z-50 gap-16 flex-col xl:flex-row justify-between`}>
                        <Stack spacing={isMobile ? 16 : 40} className={`flex-1 justify-center xl:items-start items-center`}>
                            <Flex className={`w-12 h-12 bg-blue_primary rounded-[12px] justify-center items-center`}>
                                <PeoplesIcon />
                            </Flex>
                            <Text className={`text-[24px] tracking-[-0.12rem] xl:text-[34px] !mt-4 text-center xl:text-left font-semibold`} style={{
                                lineHeight: `111%`,
                            }}>Todas as corretoras em
                                um só lugar.</Text>
                            <Text className={`!text-gray_3 inter h2-regular xl:text-[16px] text-center xl:text-left`}>
                                Conecte-se ao universo dos investimentos de uma forma revolucionária. Uma experiência <b>única</b> para os investidores que buscam uma plataforma inovadora, inteligente e intuitiva.
                            </Text>
                        </Stack>
                ...
                <Wrapper className={`items-center justify-center`}>
                    ...
                    <Flex className={`flex-1 w-full z-50 flex-col translate-y-12`}>
                        <Stack spacing={16} className={`flex-1 bg-white xl:bg-1 items-center py-8 xl:py-16 px-6 xl:px-32 rounded-t-[12px] xl:rounded-t-[24px]`}>
                            ...
                            <Text className={`!text-gray_2 xl:!text-gray_3 text-center inter text-[14px] xl:text-[16px]`}>
                                Acreditamos que inteligência e tecnologia andam juntas e são essenciais para que você possa investir com segurança e confiança. Por isso, aqui os dados são coletados diretamente da B3.
                            </Text>
                        </Stack>
                        <Flex className={`w-full h-[160px] xl:h-[320px] bg-cover bg-left xl:bg-center rounded-b-[8px] xl:rounded-b-[24px]`} style={{backgroundImage: `url(/backgrounds/home-3.png)`}}>
            ...
            <Container className={`relative bg-white z-40`}>
                <Wrapper className={`items-center justify-center`}>
                    <Stack spacing={32} className={`flex-1 items-center py-16`}>
                        <Text className={`text-[16px]  xl:text-[28px] !text-gray_1 text-center font-semibold`} style={{
                            lineHeight: `130%`
                        ...
                        <Link href={`https://dev.app.boleta.ai/fila-de-espera`} >
                            <Button className={`!px-6 !py-2 !text-[16px]`} >Solicite seu convite <ArrowTopRight className={`ml-4 xl:ml-12 scale-75 xl:scale-100`} /></Button>
                        </Link>
                        <Flex className={`w-full h-[500px] bg-[#DFE0E4] rounded-[8px] xl:rounded-[24px] !mt-16`} />
                    </Stack>
                </Wrapper>
            </Container>
                ...
                <Wrapper className={`items-center justify-center bg-cover bg-center`}>
                    <Flex className={`flex-1 w-full z-50 flex-col -translate-y-12`}>
                        <Stack spacing={16} className={`flex-1 bg-1 items-center py-8 xl:py-16 px-6 xl:px-32 rounded-t-[12px] xl:rounded-t-[24px]`}>
                            ...
                            <Text className={`!text-gray_3 text-center inter text-[14px] xl:text-[16px]`}>
                                A tecnologia desenvolvida pelo boletaai foi reconhecida como uma das melhores inovações do ano de 2022 pelo Centelha/ES.
                            </Text>
                        </Stack>
                        <Flex className={`w-full h-[160px] xl:h-[320px] bg-cover bg-center rounded-b-[8px] xl:rounded-b-[24px]`} style={{backgroundImage: `url(/backgrounds/home-5.png)`}}>
                    ...
                    <Stack spacing={24} className={`w-full`}>
                        <Stack spacing={16} className={`flex-1 bg-1 rounded-t-[24px] mb-12`}>
                            <Flex className={`items-center gap-6`}>
                                <Text className={`xl:text-[34px] tracking-[-0.12rem]  text-[24px] font-semibold`} style={{
                                    lineHeight: `111%`,
                                    letterSpacing: `-4% `
                        ...
                        <Accordion defaultExpanded={true} header={<>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>A nossa plataforma é GRATUITA na versão 1.0.</Text>
                        </Accordion>
                        ...
                        <Accordion defaultExpanded={false} header={<>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>Você pode receber o convite através de um amigo que tenha cadastro na nossa plataforma ou aguardar que sua solicitação na lista de espera seja respondida.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold xl:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>No boleta.ai fazemos tudo que a concorrência faz e você não gasta GRANA pra declarar seu CAPITAL.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold xl:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>Você acessa a nossa plataforma de qualquer navegador, tanto pelo celular como no computador.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold xl:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>TODAS as corretoras funcionam no boleta.ai, não importa se você tem conta em mais de uma.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold xl:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>Ações, FIIs (fundos de investimento imobiliário), BDRs (Brazilian Depositary Receipts), ETFs (Exchange Traded Funds), Futuros e opções.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                        <Accordion defaultExpanded={false} header={<>
                            <Text className={`text-[18px] font-semibold xl:h1-semibold`}>
                            ...
                            <Text className={`text-[14px] inter xl:text-[16px] !text-gray_3`}>Não. Os seus dados são extraídos diretamente da B3.</Text>
                        </Accordion>
                        <Flex className={`w-full h-[1px] bg-gray_1`} />
                    </Stack>
                </Wrapper>
